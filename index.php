...
$db = [
  ...
  '<h2>Come state implementando la recente adecisione della Corte di giustizia dell\'Unione europea (CGUE) relativa al diritto all\'oblio?</h2>',
...
<html lang="en" dir="ltr">
  ...
  <body>
    <header>
      <nav id="logo">
        <a href="#"><img src="https://www.google.com/images/branding/googlelogo/1x/googlelogo_color_74x24dp.png" alt=""></a>
